...
class UITesting(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.driver.get("https://react-showcase-client.herokuapp.com/")
    ...
    def test_1_register(self):
        ...
        elem.clear()
        elem.send_keys("fahlevi@gmail.com")
        ...
        # check registration
        elem = self.driver.find_element(By.XPATH, '//div[text()="fahlevi@gmail.com"]')
        self.assertEqual('fahlevi@gmail.com', elem.text)

        time.sleep(5)
        
        # delete entry with taflahi@gmail.com
        elem = self.driver.find_element(By.XPATH, '//div[text()="fahlevi@gmail.com"]/following-sibling::div')
